...
@app.get("/api/cart", response_model=DefaultResponseList, tags=["cart"])
...
@app.post("/api/cart/{product_id}", response_model=DefaultResponseDict, tags=["cart"])
...
@app.post("/api/cart", response_model=DefaultResponseList, tags=["cart"])
