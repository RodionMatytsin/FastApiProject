...
from main.schemas.response import DefaultResponseDict
...
@app.post("/api/login", response_model=DefaultResponseDict, tags=["auth"])
...
@app.post("/api/signup", response_model=DefaultResponseDict, tags=["auth"])
...
@app.get('/api/logout', response_model=DefaultResponseDict, tags=["auth"])
...
@app.get('/api/home', response_model=DefaultResponseDict, tags=["auth"])
