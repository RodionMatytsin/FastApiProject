...
from main.schemas.response import DefaultResponseList, DefaultResponseDict
...
@app.get("/api/products", response_model=DefaultResponseList, tags=["products"])
...
@app.post("/api/products", response_model=DefaultResponseDict, tags=["products"])
...
@app.get("/api/products/{product_id}", response_model=DefaultResponseDict, tags=["products"])
